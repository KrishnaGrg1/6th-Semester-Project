...
function displaySearchResults(results) {
    ...
    results.slice(0, 10).forEach(result => {
        ...
        movieItem.innerHTML = `
            ...
            <button class="add-to-playlist-btn" data-movie-id="${id}">Add to Playlist</button>
        `;
...
function displayTrendingMovie(movie) {
    ...
    movieItem.innerHTML = `
        ...
        <div class="info-button-section">
            ...
            <button id="playlist" class="add-to-playlist-btn" data-movie-id="${movie.id}">Add to Playlist</button>
        </div>
    `;
    ...
    movies.forEach(movie => {
        ...
        movieItem.innerHTML = `
            <div class="movie-item">
                ...
                <button class="add-to-playlist-btn" data-movie-id="${movieId}">Add to Playlist</button>
            </div>
        `;
...
// Add event listeners for adding movies to the playlist
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listeners for removing movies from the playlist
